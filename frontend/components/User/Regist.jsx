      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          {inputState.id != "" && idCheckRes && idCheckRes.code == 200 ? (
            <div
              className="p-4 mb-4 text-sm text-gray-700 bg-green-100 rounded-lg dark:bg-gray-700 dark:text-gray-300"
              role="alert"
            >
          ...
          {inputState.id != "" && idCheckRes && idCheckRes.code != 200 ? (
            <div
              className="p-4 mb-4 text-sm text-gray-700 bg-red-100 rounded-lg dark:bg-gray-700 dark:text-gray-300"
              role="alert"
            >
              <span className="font-medium">{idCheckRes.msg}</span>
            </div>
