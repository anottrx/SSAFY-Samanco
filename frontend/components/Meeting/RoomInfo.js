...
import { Stack, Button, Dialog, DialogTitle, DialogActions } from "@mui/material"
...
function RoomInfo() {
    ...
    const exitDialogOpen = () => { setOpen(true) }
    const exitDialogClose = () => { setOpen(false) }
    ...
    return (
        <InfoWrapper>
            ...
            <Stack>
                <div><AccessTimeIcon />10분 / 50분</div>
                <Button onClick={exitDialogOpen}><ExitToAppIcon />나가기</Button>
            </Stack>
